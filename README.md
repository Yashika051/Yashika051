...
Right now I'm building my skills through hands-on projects instead of just tutorials. I've analyzed retail sales trends to understand what drives profitability, dug into delivery operations to find where things break down, and built an AI-assisted tool for workforce planning that explains its own recommendations instead of acting like a black box.

I'm not chasing perfection, I'm chasing understanding. If a dataset confuses me, that usually means I'm about to learn something.
...
```text
1. Ask a real question about the data
2. Clean it (this always takes longer than expected)
3. Explore until something interesting shows up
4. Visualize it so it makes sense to someone else
5. Turn it into a recommendation, not just a chart
```
...
**Languages**
![Python](https://img.shields.io/badge/Python-3776AB?style=for-the-badge&logo=python&logoColor=white) ![C](https://img.shields.io/badge/C-A8B9CC?style=for-the-badge&logo=c&logoColor=white) ![C++](https://img.shields.io/badge/C%2B%2B-00599C?style=for-the-badge&logo=cplusplus&logoColor=white)
...
[🔗 Repository](https://github.com/Yashika051/CodeAlpha_EDA_SuperstoreSales)
...
**🤖 StaffSense — AI Workforce Management System**  
An AI-powered system to forecast patient demand, flag staffing shortages, and recommend optimal staff allocation.
